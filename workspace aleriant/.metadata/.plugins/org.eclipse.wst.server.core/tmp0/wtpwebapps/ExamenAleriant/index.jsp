...
<body>
	...
	<input type="hidden" name="metodo" id="metodo" value="consulta"></input>
	<input type="hidden" name="nuevoProductoActivo" id="nuevoProductoActivo" value="true"></input>
	<input type="hidden" name="idProductoModificado" id="idProductoModificado"></input>
	<input type="hidden" name="productoModificadoActivo" id="productoModificadoActivo"></input>
	<input type="hidden" name="productoEliminar" id="productoEliminar"></input>
	  ...
	  <tr>
	  	...
	  	<td>
			<a href="javascript:editarProducto('<c:out value="${item.ID}"/>','<c:out value="${item.nombre}"/>','<c:out value="${item.descripcion}"/>','<c:out value="${item.activo}"/>' )">Editar</a> 	  	
	  	</td>			  		  	 	    
	  </tr>	  
	  </c:forEach>
      </table>
      ...
      <table>
      	...
      	<tr>
      	<td>
      		Estado Activo:<input type="checkbox" name="ingresoActivo" id ="ingresoActivo" checked="checked" onclick="cambiarActivadoProducto();"></input>
      	</td>      	      
      	</tr>
      	<tr>
      	<td>
      		<a href="javascript:actualizarProducto()">Actualizar producto</a>
      	</td>
      	<td>
      		<a href="javascript:crearProducto();">Crear Nuevo producto</a>
      	</td>
